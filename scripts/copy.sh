...
mkdir data/beam_nuel_dis_cc/
mkdir data/beam_nuel_dis_nc/
mkdir data/beam_nuel_res_cc/
...
mkdir data/beam_numu_dis_cc/
mkdir data/beam_numu_dis_nc/
mkdir data/beam_numu_res_cc/
...
cp -r /unix/chips/production/beam_nuel_coh_nc/tf/chips_1200_sk1pe/ data/beam_nuel_coh_nc/
cp -r /unix/chips/production/beam_nuel_dis_cc/tf/chips_1200_sk1pe/ data/beam_nuel_dis_cc/
cp -r /unix/chips/production/beam_nuel_dis_nc/tf/chips_1200_sk1pe/ data/beam_nuel_dis_nc/
cp -r /unix/chips/production/beam_nuel_res_cc/tf/chips_1200_sk1pe/ data/beam_nuel_res_cc/
...
cp -r /unix/chips/production/beam_numu_dis_cc/tf/chips_1200_sk1pe/ data/beam_numu_dis_cc/
cp -r /unix/chips/production/beam_numu_dis_nc/tf/chips_1200_sk1pe/ data/beam_numu_dis_nc/
cp -r /unix/chips/production/beam_numu_res_cc/tf/chips_1200_sk1pe/ data/beam_numu_res_cc/
