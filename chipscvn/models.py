...
class MultiTaskModel(BaseModel):
    ...
    def build(self):
        ...
        pdg_output = Dense(self.config.model.pdgs, activation='softmax', name="pdg")(pdg_path)
        type_output = Dense(self.config.model.types, activation='softmax', name="type")(type_path)
