void cvn_pid_output_plots(const char* outputFile = "output/pid.txt", const char* plotFileName = "plots/pid_plots.root"){
    ...
    float nuelCCQETot = (float)tree->GetEntries("(label==0.0)") * w0;
    float nuelCCnonQETot = (float)tree->GetEntries("(label==1.0)") * w1;
    float numuCCQETot = (float)tree->GetEntries("(label==2.0)") * w2;
    float numuCCnonQETot = (float)tree->GetEntries("(label==3.0)") * w3;
    float allNCTot = (float)tree->GetEntries("(label==4.0)") * w4;
    ...
    for (int bin=0; bin<bins; bin++) {
        ...
        float nuelCCQECut = (float)tree->GetEntries(nuelCCQECutString.Data()) * w0;

        TString nuelCCnonQECutString = Form("(label==1.0)&&(o0+o1>%f)", cut[bin]);
        float nuelCCnonQECut = (float)tree->GetEntries(nuelCCnonQECutString.Data()) * w1;

        TString numuCCQECutString = Form("(label==2.0)&&(o0+o1>%f)", cut[bin]);
        float numuCCQECut = (float)tree->GetEntries(numuCCQECutString.Data()) * w2;

        TString numuCCnonQECutString = Form("(label==3.0)&&(o0+o1>%f)", cut[bin]);
        float numuCCnonQECut = (float)tree->GetEntries(numuCCnonQECutString.Data()) * w3;

        TString allNCCutString = Form("(label==4.0)&&(o0+o1>%f)", cut[bin]);
        float allNCCut = (float)tree->GetEntries(allNCCutString.Data()) * w4;
    ...
    tree->Draw("o0>>hist_0_0", cat_0_string.Data());
    tree->Draw("o1>>hist_0_1", cat_0_string.Data());
    tree->Draw("o2>>hist_0_2", cat_0_string.Data());
    tree->Draw("o3>>hist_0_3", cat_0_string.Data());
    tree->Draw("o4>>hist_0_4", cat_0_string.Data());
    tree->Draw("o0+o1>>hist_0_5", cat_0_string.Data());

    TString cat_1_string = Form("(%f*(label==1.0))", w1);
    tree->Draw("o0>>hist_1_0", cat_1_string.Data());
    tree->Draw("o1>>hist_1_1", cat_1_string.Data());
    tree->Draw("o2>>hist_1_2", cat_1_string.Data());
    tree->Draw("o3>>hist_1_3", cat_1_string.Data());
    tree->Draw("o4>>hist_1_4", cat_1_string.Data());
    tree->Draw("o0+o1>>hist_1_5", cat_1_string.Data());

    TString cat_2_string = Form("(%f*(label==2.0))", w2);
    tree->Draw("o0>>hist_2_0", cat_2_string.Data());
    tree->Draw("o1>>hist_2_1", cat_2_string.Data());
    tree->Draw("o2>>hist_2_2", cat_2_string.Data());
    tree->Draw("o3>>hist_2_3", cat_2_string.Data());
    tree->Draw("o4>>hist_2_4", cat_2_string.Data());
    tree->Draw("o0+o1>>hist_2_5", cat_2_string.Data());

    TString cat_3_string = Form("(%f*(label==3.0))", w3);
    tree->Draw("o0>>hist_3_0", cat_3_string.Data());
    tree->Draw("o1>>hist_3_1", cat_3_string.Data());
    tree->Draw("o2>>hist_3_2", cat_3_string.Data());
    tree->Draw("o3>>hist_3_3", cat_3_string.Data());
    tree->Draw("o4>>hist_3_4", cat_3_string.Data());
    tree->Draw("o0+o1>>hist_3_5", cat_3_string.Data());

    TString cat_4_string = Form("(%f*(label==4.0))", w4);
    tree->Draw("o0>>hist_4_0", cat_4_string.Data());
    tree->Draw("o1>>hist_4_1", cat_4_string.Data());
    tree->Draw("o2>>hist_4_2", cat_4_string.Data());
    tree->Draw("o3>>hist_4_3", cat_4_string.Data());
    tree->Draw("o4>>hist_4_4", cat_4_string.Data());
    tree->Draw("o0+o1>>hist_4_5", cat_4_string.Data());
    ...
    tree->Draw("energy>>nueCCQESel", nueCCQECutString.Data());
    ...
    tree->Draw("energy>>nueCCnonQESel", nueCCnonQECutString.Data());
    ...
    tree->Draw("energy>>numuCCAll", "(label==2.0)");
    tree->Draw("energy>>numuCCAll", "(label==3.0)");
    tree->Draw("energy>>numuCCSel", numuCCQECutString.Data());
    tree->Draw("energy>>numuCCSel", numuCCnonQECutString.Data());
    ...
    tree->Draw("energy>>NCSel", allNCCutString.Data());
